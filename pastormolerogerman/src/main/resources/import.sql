...
INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (1, '2024-11-01', 'Sofía tuvo una pequeña caída en el patio durante el recreo', 'Leve', true, 'Se aplicó hielo y se avisó a los padres. Sin consecuencias.', 1);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (2, '2024-11-02', 'Lucas presentó reacción alérgica leve durante la merienda', 'Moderada', true, 'Se administró antihistamínico y se contactó con los padres inmediatamente.', 2);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (3, '2024-11-03', 'Discusión entre Hugo y Mateo durante el juego libre', 'Leve', true, 'Se habló con ambos niños. Pidieron disculpas mutuamente.', 4);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (4, '2024-11-04', 'Emma se sintió mareada después de la actividad física', 'Moderada', true, 'Se le dio agua y descanso. Los padres fueron notificados.', 3);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (5, '2024-11-05', 'Calefacción averiada en Sala de Preescolar B', 'Grave', false, 'Se ha contactado con mantenimiento. Pendiente de reparación.', NULL);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (6, '2024-11-05', 'Daniel se golpeó la cabeza con un juguete', 'Leve', false, NULL, 6);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (7, '2024-11-06', 'Valeria presentó fiebre de 38°C durante la tarde', 'Moderada', false, 'Se informó a los padres para que vinieran a recogerla.', 7);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (8, '2024-11-07', 'Mateo tuvo un rasguño en la rodilla jugando en el patio', 'Leve', true, 'Se limpió la herida y se aplicó antiséptico. Herida leve.', 8);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (9, '2024-11-08', 'Paula se negó a comer durante el almuerzo', 'Leve', true, 'Se habló con ella y finalmente comió. Situación normal.', 9);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (10, '2024-11-09', 'Fuga de agua en el baño de la Sala de Exploradores', 'Grave', false, NULL, NULL);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (11, '2024-11-10', 'Diego presentó síntomas de conjuntivitis', 'Moderada', false, 'Padres notificados. Recomendada visita al pediatra.', 10);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (12, '2024-11-11', 'Sofía mordió a otro niño durante el juego', 'Moderada', true, 'Se habló con los padres. Se implementará seguimiento del comportamiento.', 1);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (13, '2024-11-12', 'Lucas perdió su mochila en el patio', 'Leve', true, 'La mochila fue encontrada en el área de juegos.', 2);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (14, '2024-11-13', 'Emma presentó vómitos después del almuerzo', 'Grave', false, 'Padres contactados de urgencia. Posible intoxicación alimentaria.', 3);

INSERT INTO incidencias (id, fecha, descripcion, gravedad, resuelta, observaciones_resolucion, alumno_id) VALUES (15, '2024-11-14', 'Hugo se cayó de la resbaladilla', 'Moderada', false, 'Se revisó y no presenta lesiones graves. En observación.', 4);
